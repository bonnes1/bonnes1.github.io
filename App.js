...
//Modified by Hannes Bennet for the purpose of a course in Information Visualization.
...
var colors = {
    "Indic East" :[135,145,60],
    "Islamic East" :[10,75,50],
    "Latin America" :[271,39,57],
    "New West" :[110,150,22],
    "Old West" :[70,90,39],
    "Orthodox East" :[50,150,15],
    "Reformed West" :[20,100,52],
    "Returned West" :[170,40,10],
    "Sinic East" :[60,86,61],
    "Subsaharan Africa" :[200,86,60]
...
d3.csv("data_pol.csv", function(raw_data) {
        ...
        .call(d3.behavior.drag()
            ...
            .on("drag", function(d) {
                ...
                if (dragging[d] < 12 || dragging[d] > w-12) {
                    d3.select(this).select(".background").style("fill", "#e74c44");
                } else {
